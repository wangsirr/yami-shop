...
import com.yami.shop.service.AliOSSUploadPicService;
...
public class AttachFileServiceImpl extends ServiceImpl<AttachFileMapper, AttachFile> implements AttachFileService {
	...
	@Autowired
	private AliOSSUploadPicService aliOSSUploadPicService;
    @Autowired
...
//	    Response response = uploadManager.put(bytes, fileName, upToken);
		...
		PicUploadResultVo ppp = aliOSSUploadPicService.upload( bytes,originalName,fileName);
		return fileName;
	}
